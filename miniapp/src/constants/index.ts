...
export const BUSINESS_TOOLS = [
  {
    ...
    initialOptions: [
      { label: '我想分析我的企业整体战略', value: '我想分析我的企业整体战略定位和竞争优势' },
      { label: '评估新产品或项目机会', value: '我想评估一个新产品或新项目的可行性和潜在风险' },
      { label: '分析当前面临的挑战', value: '我想分析当前业务面临的主要挑战和威胁' },
      { label: '识别市场机会与优势', value: '帮我识别市场中的机会以及我们的核心优势' }
    ]
  },
  {
    id: 'smart',
    ...
    initialOptions: [
      { label: '制定团队季度目标', value: '我想为团队制定本季度的关键绩效目标' },
      { label: '设定个人成长目标', value: '帮我制定个人职业发展的年度目标' },
      { label: '明确项目里程碑', value: '我需要为项目设定清晰的里程碑和时间节点' },
      { label: '优化现有目标', value: '我有一个模糊的目标，想让它更具体和可衡量' }
    ]
  },
  {
    id: 'matrix',
    ...
    initialOptions: [
      { label: '选择供应商或合作伙伴', value: '我需要在多个供应商/合作伙伴中做选择' },
      { label: '评估投资或资源分配', value: '我想评估几个投资方向或资源分配方案' },
      { label: '对比技术方案', value: '我需要在多个技术方案中选择最优解' },
      { label: '职业选择或战略方向', value: '我面临重要的职业选择或战略方向决策' }
    ]
  },
  {
    id: '5why',
    ...
    initialOptions: [
      { label: '分析团队效率问题', value: '我的团队执行力不足，交付经常延期' },
      { label: '客户流失原因分析', value: '最近客户流失率上升，需要找到根本原因' },
      { label: '产品质量问题', value: '产品出现质量问题，想找到深层次原因' },
      { label: '业务增长瓶颈', value: '业务增长遇到瓶颈，想找出根本制约因素' }
    ]
  }
];
